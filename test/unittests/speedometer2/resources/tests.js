...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/vanilla-examples/vanillajs/index.html',
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/vanilla-examples/es2015-babel-webpack/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    name: 'React-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/react/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/react-redux/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/emberjs/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('#new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/emberjs-debug/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('#new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/backbone/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/angularjs/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('#new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/angular/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    name: 'VueJS-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/vuejs-cli/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    name: 'jQuery-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/jquery/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('#appIsReady').then(function (element) {
...
Suites.push({
    name: 'Preact-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/preact/dist/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    ...
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/architecture-examples/inferno/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    name: 'Elm-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/functional-prog-examples/elm/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('.new-todo').then(function (element) {
            element.focus();
            return element;
...
Suites.push({
    name: 'Flight-TodoMVC',
    url: 'https://browserbench.org/Speedometer2.0/resources/todomvc/dependency-examples/flight/flight/index.html',
    prepare: function (runner, contentWindow, contentDocument) {
        return runner.waitForElement('#appIsReady').then(function (element) {
            var newTodo = contentDocument.getElementById('new-todo');
            newTodo.focus();
